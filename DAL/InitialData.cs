...
namespace UrbanCarton.Webapi.DAL
{
    ...
    {
        public static void Seed(this UrbanCartonDbContext dbContext)
        {
            if (!dbContext.Products.Any())
            {
                dbContext.Products.Add(new Product
                {
                    ...
                    Price = 219.5m,
                    Rating = 4,
                    Type = new ProductType() { Id = 1, Name = "Boots" },
                    Stock = 12,
                ...
                dbContext.Products.Add(new Product
                {
                    ...
                    Price = 199.99m,
                    Rating = 5,
                    Type = new ProductType() { Id = 2, Name = "ClimbingGear" },
                    Stock = 66,
                ...
                dbContext.Products.Add(new Product
                {
                    ...
                    Price = 350m,
                    Rating = 5,
                    Type = new ProductType() { Id = 3, Name = "Kayaks" },
                    Stock = 8,
